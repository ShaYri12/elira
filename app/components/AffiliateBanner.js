...
export default function AffiliateBanner() {
  return (
    <section className="bg-[040404] lg:py-[10px] py-[20px]">
      <div className="bg-[#001604] rounded-lg py-[30px] px-[36px] rounded-[25px]">
        <div className="flex flex-wrap justify-between items-center">
          <div className="flex gap-3 items-center lg:justify-start justify-center lg:w-auto w-full">
            ...
            <h4 className="uppercase text-[16px] text-[#009719]">
              Affiliate Program
            </h4>
          </div>
          <div className="lg:flex items-center hidden gap-5">
            <button className="bg-[#026e14] hover:bg-green-700 text-white transition py-2 px-4 rounded-lg text-[14px]">
              Start earning 💸
            </button>
            <button className="bg-transparent border border-[#026e14] transition hover:border-white text-[#026e14] text-[14px] hover:text-white font-bold py-2 px-3 rounded-lg">
              Free course
            </button>
          </div>
        </div>
        <div className="flex flex-col gap-[20px] pt-[24px]">
          <h3 className="md:text-[25px] text-[20px] lg:text-left text-center mb-2">
          ...
          <p className="text-[13px] text-[#425245] lg:max-w-[97%] lg:text-left text-center">
